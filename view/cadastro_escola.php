<?php 
	...
	require_once('../controller/c_escola.php');

	$escola = new c_escola();

	if ( isset($_POST['nome']) && isset($_POST['municipio']) ) {
	
		$nome = $_POST['nome'];
		$municipio = $_POST['municipio'];

		$escola->inserir($nome, $municipio);
						...
						<div class="box-body" >
							...
							<div class="row" >
								...
								<div class="col-md-4" >
									...
									<input type="text" name="municipio" class="form-control" id="municipio" required="required" >
								</div>
